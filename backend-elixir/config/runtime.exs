...
# Carregar variáveis de ambiente do arquivo .env se existir (para desenvolvimento)
...
#
#     PHX_SERVER=true bin/realm_agent start
#
...
if config_env() == :prod do
  ...
  #
  #     config :realm_agent, RealmAgent.Mailer,
